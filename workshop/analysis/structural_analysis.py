...
from workshop.shared.identity import deck_content_fingerprint


PROJECT_ID = "the-myr-singularity"
ANALYSIS_METHOD_ID = "structural-analysis-v1"
ANALYSIS_METHOD_VERSION = "1.1"
...
def normalize_name(value: str) -> str:
    from workshop.shared.identity import normalize_card_identity
    return normalize_card_identity(value)
...
def derive_structural_facts(root: Path):
    ...
    return {
        ...
        "deck_content_fingerprint": deck_content_fingerprint(version, facts),
